...
<?php
if (isset($_POST['form3']) && isset($_SESSION['customer'])) {
    ...
    echo "<script>alert('Thanh toán của bạn đang được xử lý. Chúng tôi sẽ liên hệ sau khi xác nhận thanh toán. Cảm ơn bạn đã mua hàng!');</script>";
